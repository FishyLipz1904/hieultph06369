...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('UI_macro_studio/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('UI_macro_studio/css/jquery-ui.css')}}">
    <link rel="stylesheet" href="{{ asset('UI_macro_studio/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{ asset('UI_macro_studio/css/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{ asset('UI_macro_studio/css/owl.theme.default.min.css')}}">

    <link rel="stylesheet" href="{{ asset('UI_macro_studio/css/jquery.fancybox.min.css')}}">

    <link rel="stylesheet" href="{{ asset('UI_macro_studio/css/bootstrap-datepicker.css')}}">

    <link rel="stylesheet" href="{{ asset('UI_macro_studio/fonts/flaticon/font/flaticon.css')}}">
    <link rel="stylesheet" href="{{ asset('UI_macro_studio/fonts/icomoon/style.css')}}">

    <link rel="stylesheet" href="{{ asset('UI_macro_studio/css/aos.css')}}">

    <link rel="stylesheet" href="{{ asset('UI_macro_studio/css/style.css')}}"> -->
